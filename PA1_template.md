...
The 5-minute interval with the highest number of steps, averaged across all days, is 835 - 840 minutes.
...
The number of missing values in the data to be modified is 2304.
